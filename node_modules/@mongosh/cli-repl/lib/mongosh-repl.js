...
class MongoshNodeRepl {
    ...
    async initialize(serviceProvider, moreRecentMongoshVersion) {
        ...
        (0, startup_timing_1.markTime)('fetched connection info');
        ...
        (0, startup_timing_1.markTime)('greeted');
        this.inspectCompact =
        ...
        (0, startup_timing_1.markTime)('fetched config vars');
        ...
        repl.line = '';
        (0, startup_timing_1.markTime)('created repl object');
        ...
        (0, startup_timing_1.markTime)('set up history file');
        ...
        (0, startup_timing_1.markTime)('finished initialization');
    ...
    async eval(originalEval, input, context, filename) {
        (0, startup_timing_1.markTime)('start repl eval');
        if (!this.insideAutoCompleteOrGetPrompt) {
        ...
        try {
            ...
            (0, startup_timing_1.markTime)('done repl eval');
            ...
            (0, startup_timing_1.markTime)('re-set prompt');
        }
    }
