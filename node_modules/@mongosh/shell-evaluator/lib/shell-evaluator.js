...
class ShellEvaluator {
    ...
    async innerEval(originalEval, input, context, filename) {
        ...
        (_f = this.markTime) === null || _f === void 0 ? void 0 : _f.call(this, 'start async rewrite');
        let rewrittenInput = this.asyncWriter.process(input);
        (_g = this.markTime) === null || _g === void 0 ? void 0 : _g.call(this, 'done async rewrite');
        ...
        if (!this.hasAppliedAsyncWriterRuntimeSupport) {
            this.hasAppliedAsyncWriterRuntimeSupport = true;
            (_h = this.markTime) === null || _h === void 0 ? void 0 : _h.call(this, 'start runtimeSupportCode processing');
            const supportCode = this.asyncWriter.runtimeSupportCode();
            if (!hasAlreadyRunGlobalRuntimeSupportEval) {
                eval(supportCode);
            }
            (_j = this.markTime) === null || _j === void 0 ? void 0 : _j.call(this, 'done global runtimeSupportCode processing');
        ...
        try {
            ...
            (_k = this.markTime) === null || _k === void 0 ? void 0 : _k.call(this, 'finished evaluating processed code');
        }
    }
